  ...
  return (
    <div className="mx-auto max-w-md">
      <div className="mb-6 text-center">
        <h1 className="text-2xl font-semibold">Sign in to CSMS</h1>
        <p className="text-sm text-gray-600">Use your Supabase email and password.</p>
      </div>
      <form onSubmit={onSubmit} className="card p-6 space-y-4">
        ...
        <div className="text-xs text-gray-500">Role comes from user app_metadata.role (Edit/View).</div>
      </form>
    </div>
  );
}
